<div>
    {{-- Cabecera de la categoría: Imagen, título y selector de vista de productos --}}
    ...
    {{-- Vista de subcategorías y listado de productos --}}
                        ...
                        <li class="bg-white rounded-lg shadow">
                            <article>
                                ...
                                <div class="py-4 px-6">
                                    ...
                                    <p class="font-bold text-gray-500">S/ {{$product->price}}</p>
                                </div>
                            </article>
                        </li>
                    @endforeach
